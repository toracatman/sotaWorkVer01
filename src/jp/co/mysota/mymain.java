...
public class mymain
{
	...
	//@<Separate/>
	public void sayEvent(String ni,String de)																			//@<BlockInfo>jp.vstone.block.func,464,2800,1872,2800,False,46,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		speechRecogResult=(String)speechRecogResult.replaceAll("新川", "に井川");											//@<BlockInfo>jp.vstone.block.calculater,528,2800,528,2800,False,45,@</BlockInfo>
																														//@<EndOfBlock/>
		int niindex=speechRecogResult.indexOf(ni);																		//@<BlockInfo>jp.vstone.block.variable,592,2800,592,2800,False,44,break@</BlockInfo>
																														//@<EndOfBlock/>
		int deindex=speechRecogResult.indexOf(de, niindex + 1);															//@<BlockInfo>jp.vstone.block.variable,656,2800,656,2800,False,43,break@</BlockInfo>
																														//@<EndOfBlock/>
		String substr="";																								//@<BlockInfo>jp.vstone.block.variable,720,2800,720,2800,False,42,break@</BlockInfo>
																														//@<EndOfBlock/>
		int sMonth=0;																									//@<BlockInfo>jp.vstone.block.variable,784,2800,784,2800,False,41,break@</BlockInfo>
																														//@<EndOfBlock/>
		try {																											//@<BlockInfo>jp.vstone.block.freeproc,848,2800,848,2800,False,40,@</BlockInfo>
			substr = speechRecogResult.substring(0, niindex);
		} catch (StringIndexOutOfBoundsException e) {
			sMonth = 0;
		}
																														//@<EndOfBlock/>
		switch((String)substr)																							//@<BlockInfo>jp.vstone.block.switch,912,2272,1040,2272,False,39,@</BlockInfo>
		{
			case (String)"一月":
			{
																														//@<OutputChild>
		...
		if(sMonth!=0)																									//@<BlockInfo>jp.vstone.block.if,1104,2752,1808,2752,False,38,コメント@</BlockInfo>
		{
																														//@<OutputChild>
			...
			GlobalVariable.sotawish.Say((String)"ちょっと待ってね",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);
																														//@<EndOfBlock/>
			String sCity=speechRecogResult.substring(niindex + 1, deindex);												//@<BlockInfo>jp.vstone.block.variable,1232,2752,1232,2752,False,35,break@</BlockInfo>
																														//@<EndOfBlock/>
			Document document;																							//@<BlockInfo>jp.vstone.block.variable,1296,2752,1296,2752,False,34,break@</BlockInfo>
																														//@<EndOfBlock/>
			int eventNum=0;																								//@<BlockInfo>jp.vstone.block.variable,1360,2752,1360,2752,False,33,break@</BlockInfo>
																														//@<EndOfBlock/>
			String say_words="";																						//@<BlockInfo>jp.vstone.block.variable,1424,2752,1424,2752,False,32,break@</BlockInfo>
																														//@<EndOfBlock/>
			try {																										//@<BlockInfo>jp.vstone.block.freeproc,1488,2752,1488,2752,False,31,@</BlockInfo>
		...
		{
																														//@<OutputChild>
			GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,1168,2848,1168,2848,False,37,@</BlockInfo>
			if(cplay != null){
			    cplay.stop();
			}
	...
	//@<Separate/>
	public void ActBye()																								//@<BlockInfo>jp.vstone.block.func,32,464,416,464,False,52,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,96,464,96,464,False,51,コメント@</BlockInfo>
		...
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,160,464,160,464,False,50,コメント@</BlockInfo>
		pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
		...
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,224,464,224,464,False,49,コメント@</BlockInfo>
		pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
		...
		GlobalVariable.motion.play(pose,700);
		CRobotUtil.wait(700);																							//@<EndOfBlock/>
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,288,464,288,464,False,48,コメント@</BlockInfo>
		pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
						new Short[]{0,690,-20,900,0,0,0,0}
						);
		pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
		...
		GlobalVariable.motion.play(pose,700);
		CRobotUtil.wait(700);																							//@<EndOfBlock/>
		pose = new CRobotPose();																						//@<BlockInfo>jp.vstone.block.pose,352,464,352,464,False,47,コメント@</BlockInfo>
		pose.SetPose(	new Byte[]{1,2,3,4,5,6,7,8},
						new Short[]{0,-900,0,900,0,0,0,0}
						);
		pose.SetTorque(	new Byte[]{1,2,3,4,5,6,7,8},
	...
	//@<Separate/>
	public void main()																									//@<BlockInfo>jp.vstone.block.func,32,144,224,144,False,55,コメント@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");
		...
		GlobalVariable.sotawish.Say((String)"プログラムを実行開始します",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);
																														//@<EndOfBlock/>
		faceTracking();																									//@<BlockInfo>jp.vstone.block.callfunc.base,160,144,160,144,False,53,@</BlockInfo>	@<EndOfBlock/>
																														//@</OutputChild>

	}																													//@<EndOfBlock/>

	//@<Separate/>
	public void faceTracking()																							//@<BlockInfo>jp.vstone.block.func,32,304,1248,304,False,68,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		GlobalVariable.robocam.setEnableFaceSearch(true);																//@<BlockInfo>jp.vstone.block.facedetect.traking,96,304,1184,304,False,67,顔追従@</BlockInfo>
		...
		try{
			GlobalVariable.detectCount=0;
																														...
																														//@<OutputChild>
			{																											//@<BlockInfo>jp.vstone.block.thread,160,304,416,304,False,66,スレッド@</BlockInfo>
				Thread th = new Thread(new Runnable() {
					...
					public void run() {
						try{
																														...
																														//@<OutputChild>
							while(GlobalVariable.TRUE)																				//@<BlockInfo>jp.vstone.block.while.endless,224,304,352,304,False,57,Endless@</BlockInfo>
							{
							
																																	//@<OutputChild>
								noDetectDuration = GlobalVariable.robocam.getNotDetectDuration();									//@<BlockInfo>jp.vstone.block.facedetect.nodetectduration.get,288,304,288,304,False,56,顔が見えていない場合、その累積時間を変数long noDetectDurationに返す。@</BlockInfo>	@<EndOfBlock/>
																																	//@</OutputChild>
							}
																																	//@<EndOfBlock/>
																																		//@</OutputChild>
				...
				th.start();
																														...
																														//@<EndOfBlock/>
			while(GlobalVariable.TRUE)																					//@<BlockInfo>jp.vstone.block.while.endless,480,304,1120,304,False,65,Endless@</BlockInfo>
			{

																														//@<OutputChild>
				GlobalVariable.faceresult = GlobalVariable.robocam.getDetectResult();									//@<BlockInfo>jp.vstone.block.facedetect.isdetect,544,256,1056,256,False,64,コメント@</BlockInfo>
				...
				if(GlobalVariable.detectCount>(int)8)
				{
					...
					GlobalVariable.robocam.setEnableFaceSearch(false);													//@<BlockInfo>jp.vstone.block.facedetect.traking.serchenable,608,256,608,256,False,63,顔追跡中に顔が見つからない場合、自動的に首を動かして周囲の顔をサーチするかどうかの設定@</BlockInfo>
																														//@<EndOfBlock/>
					GlobalVariable.sotawish.stop();																		//@<BlockInfo>jp.vstone.block.talk.say,672,256,672,256,False,62,@</BlockInfo>
					if(cplay != null){
					    cplay.stop();
					}
					...
					GlobalVariable.sotawish.Say((String)"ようこそ 秋田県庁 第二庁舎 へ",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);
																														//@<EndOfBlock/>
					while(noDetectDuration<6)																			//@<BlockInfo>jp.vstone.block.while,736,256,864,256,False,61,TRUE@</BlockInfo>
					{


																														//@<OutputChild>
						talk1();																						//@<BlockInfo>jp.vstone.block.callfunc.base,800,256,800,256,False,58,@</BlockInfo>	@<EndOfBlock/>
																														//@</OutputChild>
					}
																														//@<EndOfBlock/>
					ActBye();																							//@<BlockInfo>jp.vstone.block.callfunc.base,928,256,928,256,False,60,@</BlockInfo>	@<EndOfBlock/>
					GlobalVariable.robocam.setEnableFaceSearch(true);													//@<BlockInfo>jp.vstone.block.facedetect.traking.serchenable,992,256,992,256,False,59,顔追跡中に顔が見つからない場合、自動的に首を動かして周囲の顔をサーチするかどうかの設定@</BlockInfo>
																														//@<EndOfBlock/>
																														//@</OutputChild>
	...
	//@<Separate/>
	public mymain()																										//@<BlockInfo>jp.vstone.block.func.constructor,32,32,608,32,False,77,@</BlockInfo>
	{
																														//@<OutputChild>
		/*CPlayWave cplay*/;																							//@<BlockInfo>jp.vstone.block.variable,96,32,96,32,False,76,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*String speechRecogResult*/;																					//@<BlockInfo>jp.vstone.block.variable,160,32,160,32,False,75,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*RecogResult recogresult*/;																					//@<BlockInfo>jp.vstone.block.variable,224,32,224,32,False,74,break@</BlockInfo>
																														//@<EndOfBlock/>
		noDetectDuration=0;																								//@<BlockInfo>jp.vstone.block.variable,288,32,288,32,False,73,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*CRobotPose pose*/;																							//@<BlockInfo>jp.vstone.block.variable,352,32,352,32,False,72,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*LocalDateTime localDateTime*/;																				//@<BlockInfo>jp.vstone.block.variable,416,32,416,32,False,71,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*int getDateTimeElement*/;																						//@<BlockInfo>jp.vstone.block.variable,480,32,480,32,False,70,break@</BlockInfo>
																														//@<EndOfBlock/>
		/*int faceDetectResultAge*/;																					//@<BlockInfo>jp.vstone.block.variable,544,32,544,32,False,69,break@</BlockInfo>
																														//@<EndOfBlock/>
																														//@</OutputChild>
	}																													//@<EndOfBlock/>

	//@<Separate/>
	public Object get(String json,String code)																			//@<BlockInfo>jp.vstone.block.func,464,1456,592,1456,False,79,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		ScriptEngineManager manager = new ScriptEngineManager();														//@<BlockInfo>jp.vstone.block.freeproc,528,1456,528,1456,False,78,@</BlockInfo>
	...
	//@<Separate/>
	public void sayWeather()																							//@<BlockInfo>jp.vstone.block.func,464,1808,1360,1808,False,101,@</BlockInfo>
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");

																														//@<OutputChild>
		GlobalVariable.sotawish.stop();																					//@<BlockInfo>jp.vstone.block.talk.say,528,1808,528,1808,False,100,@</BlockInfo>
		if(cplay != null){
		    cplay.stop();
		}
		...
		GlobalVariable.sotawish.Say((String)"ちょっと待ってね",MotionAsSotaWish.MOTION_TYPE_TALK,(int)11,(int)13,(int)11);
																														//@<EndOfBlock/>
		String weather="";																								//@<BlockInfo>jp.vstone.block.variable,592,1808,592,1808,False,99,break@</BlockInfo>
																														//@<EndOfBlock/>
		String weather2="";																								//@<BlockInfo>jp.vstone.block.variable,656,1808,656,1808,False,98,break@</BlockInfo>
																														//@<EndOfBlock/>
		String strUrl = "http://weather.livedoor.com/forecast/webservice/json/v1?city=050010";							//@<BlockInfo>jp.vstone.block.freeproc,720,1808,720,1808,False,97,@</BlockInfo>
		...
		try {
			...
			try {
				...
				e.printStackTrace();
																														...
																														//@<EndOfBlock/>
		String say_words="今日の天気は";																						//@<BlockInfo>jp.vstone.block.variable,784,1808,784,1808,False,96,break@</BlockInfo>
																														//@<EndOfBlock/>
		switch((String)weather)																							//@<BlockInfo>jp.vstone.block.switch,848,1568,976,1568,False,95,@</BlockInfo>
		{
			case (String)"晴れ":
			{
																														//@<OutputChild>
				say_words+=(String)"晴れ、気分までよくなるね。";																			//@<BlockInfo>jp.vstone.block.calculater,912,1568,912,1568,False,80,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)"曇り、気分までくもっちゃうね。";																		//@<BlockInfo>jp.vstone.block.calculater,912,1664,912,1664,False,81,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)"雨、ボクはロボットだから濡れたら大変だよ。";																	//@<BlockInfo>jp.vstone.block.calculater,912,1760,912,1760,False,82,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)"雪、寒すぎるよ。";																				//@<BlockInfo>jp.vstone.block.calculater,912,1856,912,1856,False,83,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)"暴風せつ、寒すぎるよ。";																			//@<BlockInfo>jp.vstone.block.calculater,912,1952,912,1952,False,84,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)weather + "。";																			//@<BlockInfo>jp.vstone.block.calculater,912,2048,912,2048,False,85,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
		...
		say_words+=(String)"ちなみに明日は";																					//@<BlockInfo>jp.vstone.block.calculater,1040,1808,1040,1808,False,94,@</BlockInfo>
																														//@<EndOfBlock/>
		switch((String)weather2)																						//@<BlockInfo>jp.vstone.block.switch,1104,1568,1232,1568,False,93,@</BlockInfo>
		{
			case (String)"晴れ":
			{
																														//@<OutputChild>
				say_words+=(String)weather2;																				//@<BlockInfo>jp.vstone.block.calculater,1168,1568,1168,1568,False,86,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)weather2;																				//@<BlockInfo>jp.vstone.block.calculater,1168,1664,1168,1664,False,87,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)weather2;																				//@<BlockInfo>jp.vstone.block.calculater,1168,1760,1168,1760,False,88,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)weather2;																				//@<BlockInfo>jp.vstone.block.calculater,1168,1856,1168,1856,False,89,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)"暴風せつ";																					//@<BlockInfo>jp.vstone.block.calculater,1168,1952,1168,1952,False,90,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
			...
			{
																														//@<OutputChild>
				say_words+=(String)weather2;																				//@<BlockInfo>jp.vstone.block.calculater,1168,2048,1168,2048,False,91,@</BlockInfo>
																															//@<EndOfBlock/>
																																//@</OutputChild>
				break;
			}
		...
		GlobalVariable.sotawish.stop();																					//@<BlockInfo>jp.vstone.block.talk.say,1296,1808,1296,1808,False,92,@</BlockInfo>
		if(cplay != null){
		    cplay.stop();
		}
	...
	throws SpeechRecogAbortException {
		if(!GlobalVariable.TRUE) throw new SpeechRecogAbortException("default");
																														...
																														//@<OutputChild>
		recogresult = GlobalVariable.recog.getRecognitionwithAbort((int)60000);											//@<BlockInfo>jp.vstone.block.talk.speechrecog.regex2,96,576,288,576,False,197,音声認識を行い、結果を条件に正規表現文字列で比較する。認識スコアが一番高い結果に分岐する。実際に認識された文字列はspeechRecogResultに代入される@</BlockInfo>
		...
		if(speechRecogResult.contains((String)".*こんにちは.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,576,160,576,False,102,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*ここはどこ.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,672,160,672,False,103,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*お名前は.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,768,160,768,False,104,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*(バイバイ|さようなら).*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,864,160,864,False,105,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*おはよう.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,960,160,960,False,106,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*元気.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1056,160,1056,False,107,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*今日の天気は.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				sayWeather();																								//@<BlockInfo>jp.vstone.block.callfunc.base,160,1152,160,1152,False,108,@</BlockInfo>	@<EndOfBlock/>
																																//@</OutputChild>
		...
		else if(speechRecogResult.contains((String)".*ありがとう.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1248,160,1248,False,109,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*今日は何日.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				sayDate();																									//@<BlockInfo>jp.vstone.block.callfunc.base,160,1344,160,1344,False,110,@</BlockInfo>	@<EndOfBlock/>
																																//@</OutputChild>
		...
		else if(speechRecogResult.contains((String)".*いま何時.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				sayTime();																									//@<BlockInfo>jp.vstone.block.callfunc.base,160,1440,160,1440,False,111,@</BlockInfo>	@<EndOfBlock/>
																																//@</OutputChild>
		...
		else if(speechRecogResult.contains((String)".*教育庁.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1536,160,1536,False,112,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*高校教育.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1632,160,1632,False,113,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*特別支援教育.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1728,160,1728,False,114,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*義務教育.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1824,160,1824,False,115,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*保健体育.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,1920,160,1920,False,116,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*幼保.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2016,160,2016,False,117,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*公営企業.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2112,160,2112,False,118,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*うまいもの.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2208,160,2208,False,119,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*スポーツ振興.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2304,160,2304,False,120,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*文化振興.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2400,160,2400,False,121,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*文化財保護.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2496,160,2496,False,122,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*生涯学習.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2592,160,2592,False,123,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*福利.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2688,160,2688,False,124,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*施設整備.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2784,160,2784,False,125,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*情報規格.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2880,160,2880,False,126,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*情報化研修.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,2976,160,2976,False,127,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*総合防災.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3072,160,3072,False,128,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*災害対策本部.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3168,160,3168,False,129,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*産業労働.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3264,160,3264,False,130,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*三ローブ.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3360,160,3360,False,131,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*デジタル.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3456,160,3456,False,132,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*資源エネルギー産業.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3552,160,3552,False,133,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*産業集積.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3648,160,3648,False,134,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*産業政策.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3744,160,3744,False,135,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*地域産業振興.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3840,160,3840,False,136,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*ちさんか.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,3936,160,3936,False,137,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*食品工業.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4032,160,4032,False,138,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*輸送機.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4128,160,4128,False,139,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*商業貿易.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4224,160,4224,False,140,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*雇用労働.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4320,160,4320,False,141,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*活性化センター.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4416,160,4416,False,142,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*観光文化スポーツ.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4512,160,4512,False,143,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*観光連盟.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4608,160,4608,False,144,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*観光振興.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4704,160,4704,False,145,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*交通政策.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4800,160,4800,False,146,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*観光戦略.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4896,160,4896,False,147,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*北秋田市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,4992,160,4992,False,148,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*秋田市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5088,160,5088,False,149,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*仙北市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5184,160,5184,False,150,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*横手市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5280,160,5280,False,151,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*由利本荘市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5376,160,5376,False,152,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*大館市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5472,160,5472,False,153,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*男鹿市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5568,160,5568,False,154,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*湯沢市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5664,160,5664,False,155,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*鹿角市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5760,160,5760,False,156,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*八峰町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5856,160,5856,False,157,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*小坂町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,5952,160,5952,False,158,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*上小阿仁村.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6048,160,6048,False,159,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*藤里町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6144,160,6144,False,160,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*三種町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6240,160,6240,False,161,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*五城目町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6336,160,6336,False,162,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*八郎潟町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6432,160,6432,False,163,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*井川町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6528,160,6528,False,164,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*能代市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6624,160,6624,False,165,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*大潟村.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6720,160,6720,False,166,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*美郷町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6816,160,6816,False,167,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*羽後町.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,6912,160,6912,False,168,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*東成瀬村.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,7008,160,7008,False,169,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*潟上市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,7104,160,7104,False,170,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*にかほ市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,7200,160,7200,False,171,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".*大仙市.*観光スポット.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,7296,160,7296,False,172,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else if(speechRecogResult.contains((String)".+に.+で.*イベント.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				sayEvent((String)"に",(String)"で");																			//@<BlockInfo>jp.vstone.block.callfunc.base,160,7392,160,7392,False,173,@</BlockInfo>	@<EndOfBlock/>
																																//@</OutputChild>
		...
		else if(speechRecogResult.contains((String)".+の.+のイベント.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				sayEvent((String)"の",(String)"の");																			//@<BlockInfo>jp.vstone.block.callfunc.base,160,7488,160,7488,False,174,@</BlockInfo>	@<EndOfBlock/>
																																//@</OutputChild>
		...
		else if(speechRecogResult.contains((String)".*いくつに見える.*"))
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.faceresult = GlobalVariable.robocam.getDetectResult();										//@<BlockInfo>jp.vstone.block.facedetect.age.get2,160,7584,160,7584,False,176,現在認識している顔の年齢がfaceDetectResultAgeに格納される。顔が認識されない場合、faceDetectResultAgeに-1が代入される。@</BlockInfo>
				faceDetectResultAge = GlobalVariable.faceresult.getAge();													//@<EndOfBlock/>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,224,7584,224,7584,False,175,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
		...
		else
		{
			...
			if(speechRecogResult == null) speechRecogResult = "";
																														...
																														//@<OutputChild>
				GlobalVariable.sotawish.stop();																				//@<BlockInfo>jp.vstone.block.talk.say,160,7680,160,7680,False,177,@</BlockInfo>
				if(cplay != null){
				    cplay.stop();
				}
